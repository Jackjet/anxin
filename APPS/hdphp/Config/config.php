...
//    "DEBUG_AJAX"                    => 0,           //AJAX显示调试信息  已弃用
    ...
    /********************************LOG日志处理********************************/
    "LOG_SAVE"                      => 1,           //错写入日志文件
    "LOG_KEY"                       => "anxin.com", //日志文件加密KEY
    "LOG_SIZE"                      => 2000000,     //日志文件大小
    "LOG_TYPE"                      => array("error", "notice", "sql","warning"), //保存日志类型
    /********************************SESSION********************************/
    ...
    "EMAIL_FROMNAME"                => "anxin"      //发送人发件箱显示的用户名
);
?>