 ...
 function ajax_page(page){
        ...
        url=app+"/Announcement/ajaxShowPage/do/list/";
        ...
        $.post(url,{page:page},function(data){
            ...
            html +='<td class="del"><span><a href="javascript:ajax_del_announcement('+list[i].id+')">删除</a></span></td>';

            html +='<td class="edit"><span><a href="'+app+'/Announcement/toUpdate?id='+list[i].id+'">修改</a></span></td>';
  ...
  function ajax_del_announcement(id){

      url=app+"/Announcement/ajaxDelAnnou/do/list/";
