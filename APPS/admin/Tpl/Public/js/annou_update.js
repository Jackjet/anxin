...
$(document).ready(function(){
	...
	$("#update_file").click(function(){
		...
		if(!$hasUpdateFile){
			...
			$p = '<p><label for="announcement">中文文件上传</label> <input type="file" id="announcement" name="announcement" /></p><p><label for="announcement_en">英文文件上传</label> <input type="file" id="announcement_en" name="announcement_en" /></p>';
